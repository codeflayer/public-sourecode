...
- (UIImageView *)portraitImageView {
    if (!_portraitImageView) {
        ...
        _portraitImageView.layer.borderColor = [[UIColor greenColor] CGColor];
...
- (UIImageView *)addPortaitImageViewWidth:(CGFloat)imageW portraitX:(CGFloat)X portraitY:(CGFloat)Y width:(CGFloat)borderW circleColor:(UIColor *)borderColor
{
    ...
    UIImageView * imageView = [[UIImageView alloc]initImageViewWidth:imageW X:X Y:Y circleColor:borderColor borderWidth:borderW];
