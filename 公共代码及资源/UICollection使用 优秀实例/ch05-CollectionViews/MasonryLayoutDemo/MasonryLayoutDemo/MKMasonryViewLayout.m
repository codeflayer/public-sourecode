...
//将每个collectionCell的的size,以indexPath 为key，以cellSize为vuale为值，装入layoutInfo 字典中
-(void) prepareLayout {
...
#pragma  mark ------这里实现了MKMasonryViewLayoutDelegate代理方法--------
...
//遍历并取出所有cell 的size,装入一个allAttributes数组中
...
//取出最后一个cell的高度累加得到一个高度，设置collection的contentsize
