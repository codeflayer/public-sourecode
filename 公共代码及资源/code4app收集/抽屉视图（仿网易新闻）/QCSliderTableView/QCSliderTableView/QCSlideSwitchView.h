...
@property (nonatomic, assign,getter = isFirstIn)BOOL isFirstIn;//第一次进入(默认选中时候使用)
@property (nonatomic,assign)NSUInteger  firstSeletTab;//(第一次进来选中的选项)
